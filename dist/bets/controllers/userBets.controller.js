...
let UserBetsController = class UserBetsController {
    constructor(userBetsService) {
        this.userBetsService = userBetsService;
    }
};
UserBetsController = __decorate([
    (0, swagger_1.ApiTags)('UserBets'),
    (0, common_1.Controller)('user-bets'),
    __metadata("design:paramtypes", [userBets_service_1.UserBetsService])
], UserBetsController);
exports.UserBetsController = UserBetsController;
//# sourceMappingURL=userBets.controller.js.map